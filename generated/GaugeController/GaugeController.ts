...
export class GaugeController__get_corrected_infoResultValue0Struct extends ethereum.Tuple {
  get bias(): BigInt {
...
export class GaugeController extends ethereum.SmartContract {
  ...
  get_corrected_info(
    addr: Address
  ): GaugeController__get_corrected_infoResultValue0Struct {
    let result = super.call(
      "get_corrected_info",
      "get_corrected_info(address):((uint256,uint256,uint256,uint256))",
      [ethereum.Value.fromAddress(addr)]
    );

    return changetype<GaugeController__get_corrected_infoResultValue0Struct>(
      result[0].toTuple()
    );
  }

  try_get_corrected_info(
    addr: Address
  ): ethereum.CallResult<
    GaugeController__get_corrected_infoResultValue0Struct
  > {
    ...
    return ethereum.CallResult.fromValue(
      changetype<GaugeController__get_corrected_infoResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }
...
export class Change_global_emission_rateCall extends ethereum.Call {
  get inputs(): Change_global_emission_rateCall__Inputs {
    return new Change_global_emission_rateCall__Inputs(this);
  }

  get outputs(): Change_global_emission_rateCall__Outputs {
    return new Change_global_emission_rateCall__Outputs(this);
  }
}

export class Change_global_emission_rateCall__Inputs {
  _call: Change_global_emission_rateCall;

  constructor(call: Change_global_emission_rateCall) {
    this._call = call;
  }
...
export class Change_global_emission_rateCall__Outputs {
  _call: Change_global_emission_rateCall;
